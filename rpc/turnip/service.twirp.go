...
type Turnip interface {
	...
	GetContentsByTag(context.Context, *GetContentsByTagRequest) (*MultipleContentResponse, error)
...
func (c *turnipProtobufClient) GetContentsByTag(ctx context.Context, in *GetContentsByTagRequest) (*MultipleContentResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "turnipxenon.v1")
	ctx = ctxsetters.WithServiceName(ctx, "Turnip")
	ctx = ctxsetters.WithMethodName(ctx, "GetContentsByTag")
	caller := c.callGetContentsByTag
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *GetContentsByTagRequest) (*MultipleContentResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return c.callGetContentsByTag(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*MultipleContentResponse)
...
func (c *turnipProtobufClient) callGetContentsByTag(ctx context.Context, in *GetContentsByTagRequest) (*MultipleContentResponse, error) {
	out := new(MultipleContentResponse)
...
func (c *turnipJSONClient) GetContentsByTag(ctx context.Context, in *GetContentsByTagRequest) (*MultipleContentResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "turnipxenon.v1")
	ctx = ctxsetters.WithServiceName(ctx, "Turnip")
	ctx = ctxsetters.WithMethodName(ctx, "GetContentsByTag")
	caller := c.callGetContentsByTag
...
func (c *turnipJSONClient) callGetContentsByTag(ctx context.Context, in *GetContentsByTagRequest) (*MultipleContentResponse, error) {
	out := new(MultipleContentResponse)
...
func (s *turnipServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "GetAllContent":
		...
		return
	case "GetContentsByTag":
		s.serveGetContentsByTag(ctx, resp, req)
		return
	case "UpdateContent":
...
func (s *turnipServer) serveGetContentsByTag(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetContentsByTagJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetContentsByTagProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *turnipServer) serveGetContentsByTagJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetContentsByTag")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Turnip.GetContentsByTag
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *GetContentsByTagRequest) (*MultipleContentResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Turnip.GetContentsByTag(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*MultipleContentResponse)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *MultipleContentResponse and nil error while calling GetContentsByTag. nil responses are not supported"))
		return
	}
...
func (s *turnipServer) serveGetContentsByTagProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetContentsByTag")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
